def holtwinters(y, alpha, beta, gamma, c, debug=False):
    ...
    for m in range(c):
        ...
        results.append(round(forecast, 4))

    return results
 
# the time-series data.
# y =[146, 96, 59, 133, 192, 127, 79, 272, 1, 155, 98, 219, 146, 96, 59, 133, 192, 127, 79, 186, 272, 155, 98, 219, 146, 96, 59, 133, 192, 127, 79, 186, 272, 155, 98, 219, 146, 96, 59, 133, 192, 127, 79, 186, 272, 155, 98, 219 \
#                                     ,146, 96, 59, 133, 192, 127, 79, 186, 272, 155, 98, 219, 146, 96, 59, 133, 192, 127, 79, 186, 272, 155, 98, 219]
# y =range(1,118)
# print holtwinters(y, 0.2, 0.1, 0.05, 39)